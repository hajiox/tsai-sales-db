            ...
            <main className="max-w-[210mm] mx-auto p-8 print:p-0 print:m-0 print:w-full">
                ...
                <div className="border-b-2 border-gray-800 pb-4 mb-6 flex justify-between items-end">
                    ...
                    <div className="flex items-end gap-6 text-right">
                        <div>
                            <div className="text-[10px] uppercase text-gray-400 font-bold tracking-wider mb-1">販売価格</div>
                            <div className="text-3xl font-bold text-gray-900 tracking-tight flex items-center justify-end">
                                ...
                                <Input
                                    ...
                                    className="h-10 w-32 bg-transparent border-none focus-visible:ring-0 p-0 shadow-none font-bold text-3xl text-right"
                                    placeholder="-"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="text-[10px] uppercase text-gray-400 font-bold tracking-wider mb-1">粗利益</div>
                            <div className={`text-3xl font-bold tracking-tight ${profit > 0 ? 'text-gray-900' : 'text-red-600'}`}>
                                {formatCurrency(profit)}
                            </div>
                            <div className="text-xs text-gray-500 mt-1">
                                利益率: {recipe.selling_price ? (100 - ((totals.cost / recipe.selling_price) * 100)).toFixed(1) : '-'}%
                            </div>
                        </div>
                    </div>
                </div>
