...
assert.match(argBuilder, /options\.userAuthorizedBrowser/);
assert.match(argBuilder, /"--sandbox", "workspace-write", "-c", 'approval_policy="never"'/);
assert.match(bridge, /focusedContext: true,[\s\S]{0,100}userAuthorizedBrowser: true/);
