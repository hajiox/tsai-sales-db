...
assert.match(bridge, /explicit request to upload the one fixed local image/);
...
assert.match(bridge, /Do not request another approval for those exact scoped actions/);
