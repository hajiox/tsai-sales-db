        ...
        <ModalContent>
          <>
            ...
            <ModalBody>
              ...
              {error && (
                  <Card className="bg-danger-50 p-4"><CardBody><div className="flex items-center gap-2"><AlertTriangle className="text-danger" /><p className="text-danger-700">{error}</p></div></CardBody></Card>
              )}
