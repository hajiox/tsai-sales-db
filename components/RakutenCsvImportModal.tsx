              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="text-sm text-gray-600">
                    楽天商品名とマスタ商品を紐付けてください。未マッチの商品は空欄のまま保存されません。
                  </p>
                </CardHeader>
                <CardContent>
                    ...
                    {allMappings.map((mapping, index) => (
                      <div key={index} className={`p-4 border rounded-lg ${mapping.productId ? 'bg-green-50 border-green-200' : 'bg-yellow-50 border-yellow-200'}`}>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          <div>
                            <label className="text-sm font-medium text-gray-700">楽天商品名</label>
                            ...
                            {mapping.productId && (
                              <div className="mt-2 flex items-center gap-2">
                                <Button
                                  ...
                                  disabled={mapping.isLearned || savingMapping === mapping.rakutenTitle}
                                  onClick={() => handleLearnMapping(index)}
                                >
                                  {savingMapping === mapping.rakutenTitle ? (
                                    <>学習中...</>
                                  ) : mapping.isLearned ? (
                                    <>
