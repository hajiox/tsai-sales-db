...
export const formatPercent = (amount: number | null | undefined): string => {
  if (amount === null || amount === undefined) return '-';
  // example: 0.123 -> 12.3%
  return new Intl.NumberFormat('ja-JP', { style: 'percent', maximumFractionDigits: 1 }).format(amount / 100);
};
